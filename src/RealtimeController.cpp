...
double RealtimeController::powerCorrectionFactor = 1.0;
double RealtimeController::powerOffset=0.0;

void RealtimeController::setPowerCorrectionFactor(double powerCorrectionFactorArg) {
    powerCorrectionFactor = powerCorrectionFactorArg;
}
void RealtimeController::setPowerOffset(double powerOffsetArg) {
    powerOffset = powerOffsetArg;
}
double RealtimeController::correctedPower(double watts) {
    return (watts * powerCorrectionFactor) + powerOffset;
}
...
RealtimeController::processRealtimeData(RealtimeData &rtData)
{
    ...
    case 1 : // Kurt Kinetic - Cyclone
        ...
        rtData.setWatts(correctedPower((6.481090) * mph + (0.020106) * (mph*mph*mph)));
        }
        break;
    case 2 : // Kurt Kinetic - Road Machine
        ...
        double mph = rtData.getSpeed() * MILES_PER_KM;
        // using the algorithm from http://www.kurtkinetic.com/powercurve.php
        rtData.setWatts(correctedPower((5.244820) * mph + (0.019168) * (mph*mph*mph)));
        }
        break;
    case 3 : // Cyclops Fluid 2
        ...
        rtData.setWatts(correctedPower((0.0115*(mph*mph*mph)) - ((0.0137)*(mph*mph)) + ((8.9788)*(mph))));
        }
        break;
    case 4 : // BT-ATS - BT Advanced Training System
        ...
        //  where:
                ...
                double d =       0.0;
        rtData.setWatts(correctedPower(a*v*v*v + b*v*v +c*v + d));
        }
        break;
    ...
    case 5 : // Lemond Revolution
        ...
        rtData.setWatts(correctedPower((0.21*pow(V,3))+(4.25*V)));
        }
        break;
    ...
    case 6 : // 1UP USA
        ...
        rtData.setWatts(correctedPower(25.00 + (2.65f*V) - (0.42f*pow(V,2)) + (0.058f*pow(V,3))));
        }
        break;
    ...
    case 7 : //MINOURA V100 on H
        ...
        rtData.setWatts(correctedPower(pow(-0.0036*V, 3) + pow(0.2815*V,2) + (3.4978*V) - 9.7857));
        }
        break;
    ...
    case 8 : //MINOURA V100 on 5
        ...
        rtData.setWatts(correctedPower(pow(-0.0023*V, 3) + pow(0.2067*V,2) + (3.8906*V) - 11.214));
        }
        break;
    ...
    case 9 : //MINOURA V100 on 4
        ...
        rtData.setWatts(correctedPower(pow(-0.00173*V, 3) + pow(0.1825*V,2) + (3.4036*V) - 10.00));
        }
        break;
    ...
    case 10 : //MINOURA V100 on 3
        ...
        rtData.setWatts(correctedPower(pow(-0.0011*V, 3) + pow(0.1433*V,2) + (2.8808*V) - 8.1429));
        }
        break;
    ...
    case 11 : //MINOURA V100 on 2
        ...
        rtData.setWatts(correctedPower(pow(-0.0007*V, 3) + pow(0.1348*V,2) + (1.581*V) - 3.3571));
        }
        break;
    ...
    case 12 : //MINOURA V100 on 1
        ...
        rtData.setWatts(correctedPower(pow(0.0004*V, 3) + pow(0.057*V,2) + (1.7797*V) - 5.0714));
        }
        break;
    ...
    case 13 : //MINOURA V100 on L
        ...
        rtData.setWatts(correctedPower(pow(0.0557*V, 2) + (1.231*V) - 3.7143));
        }
        break;
    ...
    case 14 : //SARIS POWERBEAM PRO
        ...
        rtData.setWatts(correctedPower(pow(0.0008*V, 3) + pow(0.145*V, 2) + (2.5299*V) + 14.641));
        }
        break;
    ...
    case 15 : //  TACX SATORI SETTING 2
        ...
        rtData.setWatts(correctedPower((slope * V) + intercept));
        }
        break;
    ...
    case 34 : // ELITE SUPERCRONO POWER MAG LEVEL 1
        ...
        double V = rtData.getSpeed() * MILES_PER_KM;
        // Power curve provided by extraction from SportsTracks plugin
        rtData.setWatts(correctedPower(pow(-0.000803192769148186*V, 3) + pow(0.17689196198325*V,2) + (3.62446277061515*V) - 1.16783216783223));
        }
        break;
    ...
    case 35 : // ELITE SUPERCRONO POWER MAG LEVEL 2
        ...
        double V = rtData.getSpeed() * MILES_PER_KM;
        // Power curve provided by extraction from SportsTracks plugin
        rtData.setWatts(correctedPower(pow(-0.00590735326986424*V, 3) + pow(0.442531768374482*V,2) + (3.54843470904764*V) - 0.363636363636395));
        }
        break;
    ...
    case 36 : // ELITE SUPERCRONO POWER MAG LEVEL 3
        ...
        double V = rtData.getSpeed() * MILES_PER_KM;
        // Power curve provided by extraction from SportsTracks plugin
        rtData.setWatts(correctedPower(pow(-0.00917194323478923*V, 3) + pow(0.614352424962992*V,2) + (5.08762781732785*V) - 1.48951048951047));
        }
        break;
    ...
    case 37 : // ELITE SUPERCRONO POWER MAG LEVEL 4
        ...
        double V = rtData.getSpeed() * MILES_PER_KM;
        // Power curve provided by extraction from SportsTracks plugin
        rtData.setWatts(correctedPower(pow(-0.0150015681721553*V, 3) + pow(0.880112976720764*V,2) + (5.16903286351279*V) - 1.7342657342657));
        }
        break;
    ...
    case 38 : // ELITE SUPERCRONO POWER MAG LEVEL 5
        ...
        double V = rtData.getSpeed() * MILES_PER_KM;
        // Power curve provided by extraction from SportsTracks plugin
        rtData.setWatts(correctedPower(pow(-0.0172621671756449*V, 3) + pow(1.0207209560583*V,2) + (6.23730215622854*V) - 3.18881118881126));
        }
        break;
    ...
    case 39 : // ELITE SUPERCRONO POWER MAG LEVEL 6
        ...
        double V = rtData.getSpeed() * MILES_PER_KM;
        // Power curve provided by extraction from SportsTracks plugin
        rtData.setWatts(correctedPower(pow(-0.0195227661791347*V, 3) + pow(1.15505017633569*V,2) + (7.47138264900755*V) - 4.18881118881114));
        }
        break;
    ...
    case 40 : // ELITE SUPERCRONO POWER MAG LEVEL 7
        ...
        double V = rtData.getSpeed() * MILES_PER_KM;
        // Power curve provided by extraction from SportsTracks plugin
        rtData.setWatts(correctedPower(pow(-0.0222497351776137*V, 3) + pow(1.2917943039439*V,2) + (8.74972948026508*V) - 5.11888111888112));
        }
        break;
    ...
    case 41 : // ELITE SUPERCRONO POWER MAG LEVEL 8
        ...
        double V = rtData.getSpeed() * MILES_PER_KM;
        // Power curve provided by extraction from SportsTracks plugin
        rtData.setWatts(correctedPower(pow(-0.0255078477814972*V, 3) + pow(1.42902141301828*V,2) + (10.2050166192824*V) - 6.48951048951042));
        }
        break;
    case 42:
        {
        ...
        rtData.setWatts(correctedPower(4.31746 * V - 2.59259e-002 * pow(V, 2) + 9.41799e-003 * pow(V, 3)));
        }
        break;
    }
}
