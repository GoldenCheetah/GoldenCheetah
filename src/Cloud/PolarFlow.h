...
class PolarFlow : public CloudService {
    ...
    private:
        ...
        QJsonObject createSampleStream(QJsonDocument &document, int actualSampleLoopNumber, int timeSamplesLoopNumber); // Create "Strava"-like Streams from Polar Samples
