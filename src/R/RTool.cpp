...
RTool::RTool()
{
    ...
    try {
        ...
        R_CallMethodDef callMethods[] = {
            ...
            { "GC.chart.addCurve", (DL_FUNC) &RTool::addCurve, 15 },
              ...
              SEXP line, SEXP symbol, SEXP size, SEXP color, SEXP opacity, SEXP opengl, SEXP legend, SEXP datalabels)
{
    ...
    // add to chart
    rtool->chart->chart->addCurve(info.name, info.xseries, info.yseries, info.xname, info.yname, info.labels, info.colors, info.line, info.symbol, info.size, info.color, info.opacity, info.opengl, info.legend, info.datalabels);
