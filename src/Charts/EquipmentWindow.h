...
enum class eqWinType { BLANK_PAGE = 0, EQUIPMENT_DIST_PAGE, EQUIPMENT_SHARED_DIST_PAGE,
                        EQUIPMENT_TIME_PAGE, REFERENCE_PAGE, ACTIVITY_LINK_PAGE, SHARED_PAGE, BANNER_PAGE };
...
class EquipmentWindow : public GcChartWindow
{
    ...
    protected slots:
        ...
        void refsStartDateTimeStateChanged(int checkState);
        void refsEndDateTimeStateChanged(int checkState);
        void distStartDateTimeStateChanged(int checkState);
        void distEndDateTimeStateChanged(int checkState);
    ...
    protected:
        ...
        QWidget* createWidsEquipmentSharedDistanceItem();
        void displayEquipmentSharedDistanceItem(EquipmentSharedDistanceItem* eqNode);
        void saveEquipmentSharedDistanceItem(EquipmentSharedDistanceItem* eqNode);
        ...
        QWidget* createWidsEquipmentBanner();
        void displayEquipmentBanner(EquipmentBanner* eqBanner);
        void saveEquipmentBanner(EquipmentBanner* eqBanner);

        QWidget* createWidsSharedEquipment();
        void displaySharedEquipment(SharedEquipment* eqNode);
