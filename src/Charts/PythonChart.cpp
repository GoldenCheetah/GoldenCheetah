...
PythonChart::setWeb(bool x)
{
    ...
    if (!x && plot==NULL) {
        ...
        connect(this, SIGNAL(emitCurve(QString,QVector<double>,QVector<double>,QString,QString,QStringList,QStringList,int,int,int,QString,int,bool,bool,bool,bool)),
                plot,   SLOT( addCurve(QString,QVector<double>,QVector<double>,QString,QString,QStringList,QStringList,int,int,int,QString,int,bool,bool,bool,bool)));
