...
void RealtimeData::setAltWatts(double watts) { this->altWatts = (int)watts; }
...
void RealtimeData::setAltDistance(double x) { this->altDistance = x; }
...
void RealtimeData::setHr(double hr) { this->hr = (int)hr; }
void RealtimeData::setSpeed(double speed) { this->speed = speed; }
void RealtimeData::setWbal(double wbal) { this->wbal = wbal; }
void RealtimeData::setVirtualSpeed(double speed) { this->virtualSpeed = speed; }
...
void RealtimeData::setCadence(double aCadence) { cadence = (int)aCadence; }
void RealtimeData::setSlope(double slope) { this->slope = slope; }
void RealtimeData::setLoad(double load) { this->load = load; }
void RealtimeData::setMsecs(long x) { this->msecs = x; }
void RealtimeData::setLapMsecs(long x) { this->lapMsecs = x; }
void RealtimeData::setLapMsecsRemaining(long x) { this->lapMsecsRemaining = x; }

void RealtimeData::setErgMsecsRemaining(long x) { this->ergMsecsRemaining = x; }

void RealtimeData::setDistance(double x) { this->distance = x; }

void RealtimeData::setRouteDistance(double x) { this->routeDistance = x; }
...
void RealtimeData::setLRBalance(double x) { this->lrbalance = x; }

void RealtimeData::setLTE(double x) { this->lte = x; }

void RealtimeData::setRTE(double x) { this->rte = x; }

void RealtimeData::setLPS(double x) { this->lps = x; }

void RealtimeData::setRPS(double x) { this->rps = x; }

const char *RealtimeData::getName() const { return name; }

double RealtimeData::getAltDistance() const { return altDistance; }

double RealtimeData::getAltWatts() const { return altWatts; }
double RealtimeData::getWatts() const { return watts; }
double RealtimeData::getHr() const { return hr; }
double RealtimeData::getSpeed() const { return speed; }
double RealtimeData::getWbal() const { return wbal; }
double RealtimeData::getVirtualSpeed() const { return virtualSpeed; }
double RealtimeData::getWheelRpm() const { return wheelRpm; }
std::chrono::high_resolution_clock::time_point
RealtimeData::getWheelRpmSampleTime() const {
  return this->wheelRpmSampleTime;
}
double RealtimeData::getCadence() const { return cadence; }
double RealtimeData::getSlope() const { return slope; }
double RealtimeData::getLoad() const { return load; }
long RealtimeData::getMsecs() const { return msecs; }
long RealtimeData::getLapMsecs() const { return lapMsecs; }
double RealtimeData::getDistance() const { return distance; }
double RealtimeData::getRouteDistance() const { return routeDistance; }
double RealtimeData::getDistanceRemaining() const { return distanceRemaining; }
double RealtimeData::getLapDistance() const { return lapDistance; }
double RealtimeData::getLapDistanceRemaining() const {
  return lapDistanceRemaining;
}
double RealtimeData::getLRBalance() const { return lrbalance; }
double RealtimeData::getLTE() const { return lte; }
double RealtimeData::getRTE() const { return rte; }
double RealtimeData::getLPS() const { return lps; }
double RealtimeData::getRPS() const { return rps; }

double RealtimeData::getTorque() const { return torque; }
...
void RealtimeData::setTrainerReady(bool status) { this->trainerReady = status; }
...
bool RealtimeData::getTrainerReady() const { return trainerReady; }

bool RealtimeData::getTrainerRunning() const { return trainerRunning; }
...
bool RealtimeData::getTrainerBrakeFault() const { return trainerBrakeFault; }
...
double RealtimeData::value(DataSeries series) const {
  ...
  case LapTimeRemaining:
    return lapMsecsRemaining;
    break;

  case ErgTimeRemaining:
    return ergMsecsRemaining;
    break;
...
QString RealtimeData::seriesName(DataSeries series) {
  ...
  case LapTimeRemaining:
    return tr("Lap Time Remaining");
    break;

  case ErgTimeRemaining:
    return tr("Section Time Remaining");
    break;

  case BikeStress:
    return tr("BikeStress");
    break;
  ...
  case RI:
    return tr("Relative Intensity");
    break;

  case SkibaVI:
    return tr("Skiba Variability Index");
    break;

  case VI:
    return tr("Variability Index");
    break;
  ...
  case RouteDistance:
    return tr("Route Distance");
    break;

  case DistanceRemaining:
    return tr("Distance Remaining");
    break;

  case AltWatts:
    return tr("Alternate Power");
    break;
  ...
  case AvgSpeed:
    return tr("Average Speed");
    break;

  case AvgHeartRate:
    return tr("Average Heartrate");
    break;

  case AvgCadence:
    return tr("Average Cadence");
    break;
  ...
  case AvgHeartRateLap:
    return tr("Lap Heartrate");
    break;

  case AvgCadenceLap:
    return tr("Lap Cadence");
    break;

  case LRBalance:
    return tr("Left/Right Balance");
    break;

  case tHb:
    return tr("Total Hb Mass");
    break;

  case SmO2:
    return tr("Hb O2 Saturation");
    break;
  ...
  case LeftTorqueEffectiveness:
    return tr("Left Torque Effectiveness");
    break;

  case RightTorqueEffectiveness:
    return tr("Right Torque Effectiveness");
    break;

  case LeftPedalSmoothness:
    return tr("Left Pedal Smoothness");
    break;

  case RightPedalSmoothness:
    return tr("Right Pedal Smoothness");
    break;
  ...
  case LapDistance:
    return tr("Lap Distance");
    break;

  case LapDistanceRemaining:
    return tr("Lap Distance Remaining");
    break;
  ...
  case Rf:
    return tr("Respiratory Frequency");
    break;

  case RMV:
    return tr("Ventilation");
    break;
  ...
  case RER:
    return tr("Respiratory Exchange Ratio");
    break;

  case TidalVolume:
    return tr("Tidal Volume");
    break;

  case FeO2:
    return tr("Fraction O2 Expired");
    break;
...
void RealtimeData::setTorque(double torque) { this->torque = torque; }

void RealtimeData::setLap(long lap) { this->lap = lap; }

long RealtimeData::getLap() const { return lap; }
