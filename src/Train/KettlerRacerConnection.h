...
#ifndef _GC_KettlerRacerConnection_h
#define _GC_KettlerRacerConnection_h 1
...
class KettlerRacerConnection : public QThread
{
    Q_OBJECT

public:
    KettlerRacerConnection();
    ~KettlerRacerConnection();
...
#endif // _GC_KettlerRacerConnection_h
