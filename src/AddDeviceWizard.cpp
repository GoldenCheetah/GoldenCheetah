...
AddFinal::AddFinal(AddDeviceWizard *parent) : QWizardPage(parent), wizard(parent)
{
    ...
    virtualPower->addItem(tr("Power - Minoura V270/V130/LR320/LR540 Trainer (H)"));
    virtualPower->addItem(tr("Power - Minoura V270/V130/LR320/LR540 Trainer (5)"));
    virtualPower->addItem(tr("Power - Minoura V270/V130/LR320/LR540 Trainer (4)"));
    virtualPower->addItem(tr("Power - Minoura V270/V130/LR320/LR540 Trainer (3)"));
    virtualPower->addItem(tr("Power - Minoura V270/V130/LR320/LR540 Trainer (2)"));
    virtualPower->addItem(tr("Power - Minoura V270/V130/LR320/LR540 Trainer (1)"));
    virtualPower->addItem(tr("Power - Minoura V270/V130/LR320/LR540 Trainer (L)"));
