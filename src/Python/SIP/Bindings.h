...
class Bindings {
    ...
    public:
        ...
        bool seriesPresent(int type, PyObject* activity=NULL, int compare=-1) const;
        int seriesLast() const;
        QString seriesName(int type) const;
        PythonDataSeries *series(int type, PyObject* activity=NULL, int compare=-1) const;
        PythonDataSeries *activityWbal(PyObject* activity=NULL, int compare=-1) const;
        PythonDataSeries *xdata(QString name, QString series, QString join="repeat", PyObject* activity=NULL, int compare=-1) const;
        PythonXDataSeries *xdataSeries(QString name, QString series, PyObject* activity=NULL, int compare=-1) const;
        PyObject* xdataNames(QString name=QString(), PyObject* activity=NULL, int compare=-1) const;
    ...
    private:
        ...
        RideFile *selectRideFile(PyObject *activity = nullptr, int compare=-1) const;
