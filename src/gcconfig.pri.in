...
#if you want to build the intervals view, which is being
#developed ahead of release 3.2, but will not be included
#in the current release uncomment below
#DEFINES += GC_HAVE_INTERVALS
