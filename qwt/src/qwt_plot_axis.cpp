...
void QwtPlot::initAxesData()
{
    ...
    d_axisData[yLeft1]->scaleWidget->setObjectName( "QwtPlotAxisYLeft1" );
    d_axisData[yLeft2]->scaleWidget->setObjectName( "QwtPlotAxisYLeft2" );
    d_axisData[yLeft3]->scaleWidget->setObjectName( "QwtPlotAxisYLeft3" );

    d_axisData[yRight]->scaleWidget->setObjectName( "QwtPlotAxisYRight" );

    d_axisData[yRight1]->scaleWidget->setObjectName( "QwtPlotAxisYRight1" );
    d_axisData[yRight2]->scaleWidget->setObjectName( "QwtPlotAxisYRight2" );
    d_axisData[yRight3]->scaleWidget->setObjectName( "QwtPlotAxisYRight3" );
