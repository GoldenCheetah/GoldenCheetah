...
# Hardcode python version for Linux to avoid fragile auto-detection
echo "PYTHONINCLUDES = $(python3.11-config --includes)" >> src/gcconfig.pri
echo "PYTHONLIBS = $(python3.11-config --ldflags --embed)" >> src/gcconfig.pri
# GSL
